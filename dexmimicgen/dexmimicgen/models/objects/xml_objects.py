...
class CoffeeMachineBodyObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/coffee_body.xml"),
            name=name,
            joints=None,
            obj_type="all",
            duplicate_collision_geoms=True,
...
class CoffeeMachineLidObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/coffee_lid.xml"),
            name=name,
            joints=None,
            obj_type="all",
            duplicate_collision_geoms=True,
...
class CoffeeMachineBaseObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/coffee_base.xml"),
            name=name,
            joints=None,
            obj_type="all",
            duplicate_collision_geoms=True,
...
class DrawerObject(MujocoXMLObject):
    ...
    def __init__(self, name, joints=None):
        path_to_cabinet_xml = xml_path_completion("objects/cabinet.xml")
...
class LongDrawerObject(MujocoXMLObject):
    ...
    def __init__(self, name, joints=None):
        ...
        path_to_cabinet_xml = xml_path_completion("objects/drawer_long.xml")
