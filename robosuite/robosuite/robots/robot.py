...
class Robot(object):
    ...
    def load_model(self):
        ...
        for arm in self.arms:
            ...
            # print(f"robot name: {self.name}, gripper mount pos offset: {custom_gripper_mount_pos_offset}")
            custom_gripper_mount_quat_offset = self.robot_model.gripper_mount_quat_offset.get(arm, None)
            # print(f"robot name: {self.name}, gripper mount quat offset: {custom_gripper_mount_quat_offset}")
