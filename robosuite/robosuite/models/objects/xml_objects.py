...
class DrillObject_001(MujocoXMLObject):
    """
    Drill object 1 (e-drill_1.xml)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/e-drill_1.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")], # 设置None则物体固定，也可以设置joints=[dict(type="free", damping="0.0005")]使得物体可以自由移动
            obj_type="all",
            duplicate_collision_geoms=False,
        )


class DrillObject_002(MujocoXMLObject):
    """
    Drill object 2 (e-drill_2.xml)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/e-drill_2.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")], # 设置None则物体固定，也可以设置joints=[dict(type="free", damping="0.0005")]使得物体可以自由移动
            obj_type="all",
            duplicate_collision_geoms=False,
...
class WoodBlockObject_001(MujocoXMLObject):
    """
    Wood block object 1 (wood_block.xml)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/wood_block.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")], # 设置None则物体固定，也可以设置joints=[dict(type="free", damping="0.0005")]使得物体可以自由移动
            obj_type="all",
            duplicate_collision_geoms=False,
...
class AluminumBoxObject_001(MujocoXMLObject):
    """
    Aluminum box object 1 (aluminum_box.xml)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/aluminum_box.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")], # 设置None则物体固定，也可以设置joints=[dict(type="free", damping="0.0005")]使得物体可以自由移动
            obj_type="all",
            duplicate_collision_geoms=False,
